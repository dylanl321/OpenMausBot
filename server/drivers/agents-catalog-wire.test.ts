...
const BUDGET_BASELINE: Record<string, number> = {
  "direct": 41_742,
  "direct+shared": 43_487,
  "direct+skills": 43_668,
  "direct+skills+shared": 45_413,
  "room": 40_376,
  "room+shared": 42_121,
  "room+skills": 42_302,
  "room+skills+shared": 44_047,
  "room+own-thread": 41_663,
  "room+own-thread+shared": 43_408,
  "room+own-thread+skills": 43_589,
  "room+own-thread+skills+shared": 45_334,
  "external": 3_030,
