...
const BUDGET_BASELINE: Record<string, number> = {
  "direct": 41_263,
  "direct+shared": 43_008,
  "direct+skills": 43_189,
  "direct+skills+shared": 44_934,
  "room": 39_897,
  "room+shared": 41_642,
  "room+skills": 41_823,
  "room+skills+shared": 43_568,
  "room+own-thread": 41_184,
  "room+own-thread+shared": 42_929,
  "room+own-thread+skills": 43_110,
  "room+own-thread+skills+shared": 44_855,
  "external": 3_030,
