...
const BUDGET_BASELINE: Record<string, number> = {
  "direct": 42_570,
  "direct+shared": 44_315,
  "direct+skills": 44_496,
  "direct+skills+shared": 46_241,
  "room": 41_204,
  "room+shared": 42_949,
  "room+skills": 43_130,
  "room+skills+shared": 44_875,
  "room+own-thread": 42_491,
  "room+own-thread+shared": 44_236,
  "room+own-thread+skills": 44_417,
  "room+own-thread+skills+shared": 46_162,
  "external": 3_030,
